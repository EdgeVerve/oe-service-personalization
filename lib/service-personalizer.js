  ...
  for (var i in instructions) {
    if (instructions.hasOwnProperty(i)) {
      ...
      switch (instruction) {
        case 'fieldReplace':
          arr.push(function () {
            reverseFieldReplacementFn(ctx, p13nRule[instruction]);
          });
        ...
        case 'fieldValueReplace':
          ...
          arr.push(function () {
            reverseFieldValueReplacementFn(ctx, p13nRule[instruction]);
          });
          break;
        default:
      }
...
function addFieldValueReplace(ctx, replacements, cb) {
  var input;
...
function addFieldReplace(ctx, replacements, cb) {
  var input;
  var result = ctx.result || ctx.accdata;
