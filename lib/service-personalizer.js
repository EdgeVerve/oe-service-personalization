...
function doMethodGating(ctx, currentPersonalizationRecords, cb) {
...
function getPersonalizationMeta(ctx, info, isBeforeRemote) {
  ...
  // TODO: Assign data based on http method only - no need of switch statement
  if (isStatic) {
    switch (methodName) {
      case 'create':
      case 'patchOrCreate':
